<nav id="nav-bar" class="navbar navbar-expand-lg navbar-light px-lg-3 py-lg-2 shadow-sm sticky-top" style="background-color: #2EC1AC
;">
    <!-- Nội dung -->
  <div class="container-fluid">
    <a class="navbar-brand me-5 fw-bold fs-3 h-font" href="index.php">Trà Vinh Hotel</a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <div class="d-flex">
        <?php 
          ...
          {
            echo<<<data
              <button type="button" class="btn btn-outline-dark bg-dark text-white shadow-none me-lg-3 me-2" data-bs-toggle="modal" data-bs-target="#loginModal">
                Đăng Nhập
              </button>
              <button type="button" class="btn btn-outline-dark bg-dark text-white shadow-none" data-bs-toggle="modal" data-bs-target="#registerModal">
                Đăng Ký
              </button>
            data;
          }
